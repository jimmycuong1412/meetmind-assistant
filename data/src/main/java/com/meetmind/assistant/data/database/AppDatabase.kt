package com.meetmind.assistant.data.database
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         *   for Interview Mode STAR card classification ("behavioural" | "technical" |
         *   "situational" | null). Existing rows default to NULL (no classification).
         */
