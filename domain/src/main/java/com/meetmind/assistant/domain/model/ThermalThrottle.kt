 ...
 *
 * Exposed as a Flow by [com.meetmind.assistant.domain.repository.LlmRepository]
 * and consumed by [com.meetmind.assistant.domain.usecase.sync.SyncSttLlmUseCase]
