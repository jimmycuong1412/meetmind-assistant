...
data class AppSettings(
    ...
    val englishCoachIntervalSeconds: Int = 5,  // 5 s fallback; primary path is per-segment reactive
    ...
    val englishCoachSystemPrompt: String = "",
    ...
    val englishCoachDefaultStrategy: InsightStrategy = InsightStrategy.REAL_TIME,
