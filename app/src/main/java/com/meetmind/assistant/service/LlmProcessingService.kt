 ...
 *
 * Architecture:
 * - Started by [com.meetmind.assistant.service.LlmProcessingServiceControllerImpl] before any
...
class LlmProcessingService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.meetmind.assistant.action.START_LLM_PROCESSING"
        const val ACTION_STOP = "com.meetmind.assistant.action.STOP_LLM_PROCESSING"
    }
